...
class Admin::LanguagesControllerTest < ActionController::TestCase
  ...
  test "should create admin_language" do
    assert_difference('Admin::Language.count') do
      post :create, admin_language: { code: @admin_language.code, icon: @admin_language.icon, is_active: @admin_language.is_active, name: @admin_language.name }
    end
  ...
  test "should update admin_language" do
    patch :update, id: @admin_language, admin_language: { code: @admin_language.code, icon: @admin_language.icon, is_active: @admin_language.is_active, name: @admin_language.name }
    assert_redirected_to admin_language_path(assigns(:admin_language))
  end
